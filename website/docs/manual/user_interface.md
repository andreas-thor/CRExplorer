...
* **CP-IN (Cumulative Percentage including Ties)**: Represents the percentage of CRs within an RPY that have a lower or equal citation frequency (N_CR) in the sorted distribution. Papers sharing the same N_CR value are fully included in this cumulative total ([Bornmann & Williams, 2020](https://doi.org/10.1007/s11192-020-03512-7)).
* **CP-EX (Cumulative Percentage excluding Ties)**: Represents the percentage of references within an RPY that have a strictly lower citation frequency (N_CR) in the sorted distribution. Papers sharing the same N_CR value are explicitly excluded from this cumulative total ([Bornmann & Williams, 2020](https://doi.org/10.1007/s11192-020-03512-7)).
